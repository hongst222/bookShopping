...
class NoticeService {
    ...
    async getUList(params) {
        ...
        try {
            ...
            let sql = mybatisMapper.getStatement('NoticeMapper', 'selectUList', params);
            let [result] = await dbcon.query(sql);
    ...
    async addItem(params) {
        ...
        try {
            ...
            sql = mybatisMapper.getStatement('NoticeMapper', 'selectItem', {noticeNo: insertId});
            let [result] = await dbcon.query(sql);
    ...
    async editItem(params) {
        ...
        try {
            ...
            // 새로 저장된 데이터의 PK값을 활용하여 다시 조회
            sql = mybatisMapper.getStatement('NoticeMapper', 'selectItem', {noticeNo: params.noticeNo});
            let [result] = await dbcon.query(sql);
