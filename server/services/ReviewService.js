...
class ReviewService {
    ...
    constructor() {
        ...
        mybatisMapper.createMapper([
            './server/mappers/ReviewMapper.xml'
        ]);
    }
    ...
    async getItem(params) {
        ...
        try {
            ...
            let sql = mybatisMapper.getStatement('ReviewMapper', 'selectItem', params);
            let [result] = await dbcon.query(sql);
    ...
    async addItem(params) {
        ...
        try {
            ...
            sql = mybatisMapper.getStatement('ReviewMapper', 'selectItem', {reviewNo: insertId});
            let [result] = await dbcon.query(sql);
    ...
    async editItem(params) {
        ...
        try {
            ...
            let sql = mybatisMapper.getStatement('ReviewMapper', 'updateItem', params);
            ...
            // 새로 저장된 데이터의 PK값을 활용하여 다시 조회
            sql = mybatisMapper.getStatement('ReviewMapper', 'selectItem', {reviewNo: params.reviewNo});
            let [result] = await dbcon.query(sql);
    ...
    async getCount(params) {
        ...
        try {
            ...
            let sql = mybatisMapper.getStatement('ReviewMapper', 'selectCountAll', params);
            let [result] = await dbcon.query(sql);
